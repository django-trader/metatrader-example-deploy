...
mt5file='/config/.wine/drive_c/Program Files/MetaTrader 5 - ActivTrades/terminal64.exe'
...
local_mt5_installer="/Metatrader/terminal64.exe"
...
if [ -e "$mt5file" ]; then
    ...
    show_message "[3/7] COPYING MT5 installer..."
    cp "$local_mt5_installer" "/config/.wine/drive_c/mt5setup.exe"
